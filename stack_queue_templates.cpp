/*
================================================================================
STACK AND QUEUE IMPLEMENTATIONS USING C++ TEMPLATES
For University DSA Course
================================================================================

WHAT ARE TEMPLATES?
-------------------
Templates in C++ allow you to write generic code that works with any data type.
Think of them as blueprints that the compiler uses to generate type-specific code.

Python Comparison:
    In Python, you don't need templates because Python is dynamically typed:
    stack = []  # Can hold any type
    
    In C++, we need templates to achieve similar flexibility:
    Stack<int> intStack;
    Stack<string> stringStack;

TEMPLATE SYNTAX:
    template <typename T>  or  template <class T>
    Both are equivalent. T is a placeholder for any data type.
*/
...
private:
    ...
    struct Node {
        T data;           // The actual data (generic type T)
